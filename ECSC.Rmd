...
df_ecbi_ordered$Child_ID = recode(df_ecbi_ordered$Child_ID, "bc" = "207", "BLC" = "207", "BT" = "230", "EB" = "231", "eb" = "231", "Eb" = "231", "EJB" = "231", "ep" = "233", "EP" = "233", "gaj" = "234", "GAJ" = "234", "GJ" = "234", "LK"  = "235", "sctm" = "236", "SCTM" = "236", "XJ" = "237", "zlm" = "238", "ZLM" = "238", "zm" = "238", "ZM" = "238")
...
graph2_intensity
ggsave('graph2_intensity.png', graph2_intensity, bg='transparent')

summary(lm(data = intensity_final_df, change ~ n))


# explore
test = df_intensity %>% group_by(Child_ID) %>% nest()
